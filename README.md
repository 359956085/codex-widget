...
Codex CLI 额度小组件是一个桌面悬浮工具。它通过本机已登录的 Codex CLI 读取额度信息，并用面板或悬浮球展示当前可用额度、窗口额度、剩余重置次数、刷新时间和重置时间。
...
- 主题切换：设置中可选择默认主题或基础主题 1；默认主题保持经典样式，基础主题 1 使用玻璃拟态样式。
